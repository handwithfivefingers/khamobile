...
import { Button, ButtonGroup, ButtonToolbar, Content, FlexboxGrid, Form, IconButton, Input, InputNumber } from 'rsuite';
					...
					<div className='col-12 bg-w rounded'>
						<CardBlock>
							<Form.Group controlId='variable'>
								<Form.ControlLabel>Biến thể: {TEXT[props.variableKey]}</Form.ControlLabel>
								<Form.Control name={'groupVariable'} accepter={OptionsControlInput} label={TEXT[props.variableKey]} />
							</Form.Group>
						</CardBlock>
