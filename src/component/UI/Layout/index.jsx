    ...
    <>
      <Head>
        ...
        <link
          ...
          sizes="57x57"
          href="/theme/frontend/images/favicon/favicon-app-57.png"
        />
        <link
          rel="apple-touch-icon-precomposed"
          sizes="114x114"
          href="/theme/frontend/images/favicon/favicon-app-114.png"
        />
        <link
          rel="apple-touch-icon-precomposed"
          sizes="72x72"
          href="/theme/frontend/images/favicon/favicon-app-72.png"
        />
        <link
          rel="apple-touch-icon-precomposed"
          sizes="144x144"
          href="/theme/frontend/images/favicon/favicon-app-144.png"
        />
        <link
          rel="apple-touch-icon-precomposed"
          sizes="60x60"
          href="/theme/frontend/images/favicon/favicon-app-60.png"
        />
        <link
          rel="apple-touch-icon-precomposed"
          sizes="120x120"
          href="/theme/frontend/images/favicon/favicon-app-120.png"
        />
        <link
          rel="apple-touch-icon-precomposed"
          sizes="76x76"
          href="/theme/frontend/images/favicon/favicon-app-76.png"
        />
        <link
          rel="apple-touch-icon-precomposed"
          sizes="152x152"
          href="/theme/frontend/images/favicon/favicon-app-152.png"
        />
