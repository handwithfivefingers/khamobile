              ...
              <div className={clsx([styles.vr, 'col-lg-12 col-md-12'])}>
                <div className="row gy-4">
                  ...
                  <div className="col-12 col-md-12 col-lg-7">
                    <VariableListItem data={data} _relationProd={_relationProd} slug={slug} />
...
const VariableListItem = ({ data, _relationProd, ...props }) => {
  ...
  const onResetAttributes = (clear = false) => {
    queryRef.current = {}
    ...
    let attributeData = attributes?.map(({ name, value }) => {
      return {
        ...
        value: value?.map((_val) => {
          return { v: _val, active: true }
        }),
      }
    })
    setAttributes(attributeData)
    if (clear) setForm((prevState) => ({ ...prevState, price: null, variantId: null }))
  }
        ...
        <div className="w-100 d-flex flex-column position-relative">
          <div>
            <IconButton
              ...
              circle
              size="xs"
              onClick={() => onResetAttributes(true)}
  ...
  // console.log(_relationProd, form, activeVariant)
  console.log(form)
  return (
    <CardBlock className="border-0">
