...
router.post('/post', upload.fields([{ name: 'postImg', maxCount: 1 }]), validateCreatePost, isRequiresValidated, createPost);

router.post('/post/:_id', upload.fields([{ name: 'postImg', maxCount: 1 }]), validateCreatePost, isRequiresValidated, updatePost);
